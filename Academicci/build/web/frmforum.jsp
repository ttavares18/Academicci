                    ...
                    <div class="right_content">  
                        ...
                        <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="rounded"><b>Quais são os tipos de variáveis existentes em c++?</b></th>
                                    <th scope="col" class="rounded"><b>Thaís Tavares</b></th>
                                    
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>Acho que são int, float, string e char</td>
                                    <td>Adriana</td>
                                </tr>
                                <tr>
                                    <td>Tem do tipo long também</td>
                                    <td>Alexandre</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <fieldset>
                            <dl>
                                ...
                                <dd><input type="text" name="" id="" size="36" /></dd>
                            </dl>
                            <dl>
                                <dt><label for="comments">Resposta:</label></dt>
                                <dd><textarea name="comments" id="comments" rows="5" cols="56"></textarea></dd>
                            </dl>
                            <dl class="submit">
