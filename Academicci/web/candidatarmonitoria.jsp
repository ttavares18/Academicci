                ...
                <div class="center_content">  
                    ...
                    <div class="left_content">
                        ...
                        <div class="sidebarmenu">
                            ...
                            <a class="menuitem_red" href="frmcadastro.jsp">Candidatar a Monitoria</a>
                        ...
                        <div class="form">
                            <form action="CadastroSV" method="POST" class="niceform">
                                ...
                                <fieldset>
                                    ...
                                    <dl>
                                        <dt><label for="matricula">Preencha com seu número de Matricula:</label></dt>
                                    ...
                                    <dl class="submit">
                                        <input type="submit" name="btn" value="Candidatar" />
                                    </dl>
